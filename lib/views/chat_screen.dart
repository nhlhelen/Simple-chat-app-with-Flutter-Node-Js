...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    try {
      ...
      print("initstate socket is null ${socket == null}");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text('Chat Screen'), backgroundColor: const Color(0xFF271160)),
      body: SafeArea(
        child: Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Padding(
                        ...
                        child: Column(
                          mainAxisAlignment: _messages.isEmpty ? MainAxisAlignment.center : MainAxisAlignment.start,
                          children: <Widget>[
                            Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: FloatingActionButton(
                        ...
                        mini: true,
                        child: Transform.rotate(angle: 5.79449, child: const Icon(Icons.send, size: 20)),
                      ),
                    ),
                  ],
                ),
